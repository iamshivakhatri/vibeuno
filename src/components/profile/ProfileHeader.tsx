...
//       const response = await axios.post('/api/aws-cover', {
//         id: user.id, // Send the user ID
//       });
  
//       // Step 2: Extract the presigned URL from the response
...
//       // Step 4: Upload the file directly to S3 using the presigned URL
...
//       // Step 6: Update the UI or reload the page to reflect the changes
//       window.location.reload(); // Reload the page to show the new cover photo
//     } catch (error) {
//       console.error(error);
...
//     try {
//       // Step 1: Request a presigned URL from the server
//       const response = await axios.post("/api/aws-profile", {
//         id: user.id, // Send the user ID
//       });
...
//       // Step 4: Update the UI or reload the page to reflect the changes
//       window.location.reload(); // Reload the page to show the new profile picture
//     } catch (error) {
//       console.error(error);
...
//           <label
//             htmlFor="coverPhoto"
//             className="absolute top-2 right-2 bg-gradient-to-r from-rose-400 to-purple-400 cursor-pointer rounded-full p-2 hover:opacity-80 transition-opacity z-10" // Add z-10 to ensure it's above the cover photo
//           >
      ...
      {/* Cover Photo */}
       <div className="relative h-[225px] sm:h-[250px] md:h-[300px] w-full">
        ...
        {isCurrentUser && (
          <label
            htmlFor="coverPhoto"
            className="absolute top-2 right-2 bg-gradient-to-r from-rose-400 to-purple-400 cursor-pointer rounded-full p-2 hover:opacity-80 transition-opacity"
          >
            <Camera className="w-5 h-5 text-white" />
            <input
              type="file"
