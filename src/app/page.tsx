...
export default function LandingPage() {
  return (
    <div className="flex  flex-col bg-gradient-to-br from-blue-50 to-purple-50">
      <header className="px-4 lg:px-6 h-16 flex items-center shadow-md bg-white">
        <Link className="flex items-center" href="/">
          <Sparkles className="h-6 w-6 text-pink-500" />
          <span className="ml-2 text-xl font-extrabold text-gray-800">Narravibe</span>
        </Link>
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="py-16 bg-gradient-to-tr from-white via-blue-100 to-pink-100 text-gray-800">
          <div className="container mx-auto px-6 text-center">
            <Badge className="rounded-full px-4 py-2 bg-pink-500 text-white font-semibold">
            ...
            <div className="mt-8 flex justify-center gap-4">
              <Link href="/dashboard">
                <Button className="bg-pink-500 hover:bg-pink-600 text-white px-8 py-3 rounded-lg text-lg">
                  Get Started <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Button
                variant="outline"
                className="border-pink-500 text-pink-500 hover:bg-pink-50 px-8 py-3 rounded-lg text-lg"
              >
                View Demo
              </Button>
            </div>
        ...
        {/* Pricing Section */}
        <section id="pricing" className="py-16 bg-gradient-to-bl from-purple-50 to-blue-100 text-gray-800">
          <div className="container mx-auto px-6 text-center">
